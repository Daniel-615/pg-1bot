...
const FIXED_MESSAGE_KEYS: Record<string, string> = {
  ...
  "Ya agregaste una espera de conexion con Rocky en este flujo": "semanticCodeyRockyAlreadyWaiting",
  "Conviene conectar a Rocky antes de usar bloques de movimiento": "semanticCodeyRockyActionNeedsConnect",
  "Conviene conectar a Rocky antes de usar bloques de sensores o luces de Rocky": "semanticCodeyRockySensorNeedsConnect",
  "El texto de la pantalla no deberia estar vacio": "semanticCodeyAppearanceTextEmpty",
  "El texto puede ser demasiado largo para verse completo de un vistazo en la pantalla de Codey": "semanticCodeyAppearanceTextLong",
  "La posicion x/y de imagen o texto deberia mantenerse dentro del rango visible": "semanticCodeyAppearanceOffsetRange",
  "Las coordenadas del pixel deberian estar entre x 0-15 e y 0-7": "semanticCodeyAppearancePixelRange",
  "La potencia de Rocky deberia estar entre -100 y 100": "semanticCodeyRockyPowerRange",
  "La potencia de Rocky deberia ser distinta de 0": "semanticCodeyRockyPowerZero",
  "El tiempo de movimiento de Rocky deberia ser mayor que 0": "semanticCodeyRockyTimePositive",
  "Los grados de giro de Rocky deberian ser mayores que 0": "semanticCodeyRockyAnglePositive",
  "La duracion de la luz deberia ser mayor que 0": "semanticCodeyLightingTimePositive",
  "El valor del LED deberia estar entre 0 y 255": "semanticCodeyLightingValueRange",
  "Ese valor de LED es 0. Si quieres apagarlo, conviene usar el bloque de apagar": "semanticCodeyLightingValueZero",
  "Ese color equivale a apagar el LED. Conviene usar el bloque de apagar": "semanticCodeyLightingColorOff",
  "El mensaje infrarrojo no deberia estar vacio": "semanticCodeyIrMessageEmpty",
  "Debes grabar primero una senal infrarroja del control antes de enviarla": "semanticCodeyIrLearnRequired",
  "Ese bloque repite la misma expresion o pantalla que el anterior y puede no producir un cambio visible": "semanticCodeyDisplayRepeated",
  "Ese bloque repite el mismo estado de luz que el anterior y puede no producir un cambio visible": "semanticCodeyLightingRepeated",
  "Ese bloque repite el mismo sonido o ajuste de audio que el anterior y puede no producir un cambio apreciable": "semanticCodeySpeakerRepeated",
  "Rocky ya estaba detenido por el bloque anterior": "semanticCodeyRockyStopRepeated",
  "Ya reiniciaste el temporizador de Codey en este flujo": "semanticCodeyTimerResetRepeated",
  "Ya reiniciaste ese angulo de rotacion de Codey en este flujo": "semanticCodeyRotationResetRepeated",
